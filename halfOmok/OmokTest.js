...
function A() {
    ...
    assert.strictEqual( game.putStone("H10") instanceof PutComplete ,true)
    assert.strictEqual( game.putStone("가난다다난ㅁㅇㄹ") instanceof InvalidPosition ,true)
    assert.strictEqual( game.putStone("H10") instanceof Occupied ,true)
...
function D() {
    ...
    game.putStone("A6");
    game.putStone("k5");
    assert.strictEqual( game.putStone("A5") instanceof WhiteWins  ,true)
    console.log(game.getTurn());
    console.log(game.getImage());
}
...
function I() {
    ...
    assert.strictEqual( testUndo instanceof Undo  ,true)
}
